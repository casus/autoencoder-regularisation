...
(model, model_reg, loss_arr_reg, loss_arr_reco, loss_arr_base, loss_arr_val_reco, loss_arr_val_base) = train_ae.train(train_loader, test_loader, noChannels, dx, dy, no_epochs=100, TDA=0.05, reco_loss="mse", latent_dim=40, 
