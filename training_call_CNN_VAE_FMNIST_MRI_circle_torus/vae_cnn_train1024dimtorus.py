...
from vae import Flatten, UnFlatten, VAE, VAE3232input, ConvVAE_circle1024
...
z_dim = latent_dim
TDA = 1.0
model = ConvVAE_circle1024(image_channels=1, h_dim=256, z_dim=z_dim).to(device)
...
torch.save(model.state_dict(), path+'/model_base_cnn_vae_1024tor24000'+name)
