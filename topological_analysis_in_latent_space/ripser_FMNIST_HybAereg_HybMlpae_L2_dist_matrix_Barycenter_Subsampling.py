...
for i in range(len(latent_dims)):
    ...
    #all_rec_bAE_test_barycenters = get_convergent_barycenters(all_rec_bAE_test[i], all_rec_bAE_test[i][0], latent_dims[i]*0.015)
    ...
    plt.xlabel('Birth',fontsize=15)
    plt.ylabel('Death' ,fontsize=15)
    plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/plots_from_topology2/PH_FMNIST_HybAeRegLatDim'+str(latent_dims[i])+'_L2_dist_matrix_L2BarycneterSubsampling_size200.png')
    #plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/plots_from_topology2/PH_FMNIST_HybMLPAELatDim'+str(latent_dims[i])+'_L2_dist_matrix_L2BarycneterSubsampling_size200.png')
    plt.close()
