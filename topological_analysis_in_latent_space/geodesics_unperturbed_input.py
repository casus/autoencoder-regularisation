...
for k in Geodesic:
    ...
    plt.axis('off')
    if(aereg):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_unperturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'/AE_REG/gamma'+str(t)+'value.png')
    else:
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_unperturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'/MLP_AE/gamma'+str(t)+'value.png')
