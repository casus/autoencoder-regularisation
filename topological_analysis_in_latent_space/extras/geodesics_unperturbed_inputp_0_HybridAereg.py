...
testImages = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders-STORAGE_SPACE/FMNIST_RK_coeffs/testImages_N_70.pt',map_location=torch.device('cpu'))
...
for k in Geodesic:
    ...
    plt.axis('off')
    if(aereg):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/AE_REG/gamma'+str(t)+'value.png')
    if(Hybrid_aereg):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/Hybrid_AE_REG/gamma'+str(t)+'value.png')
    if(mlpae):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/MLP_AE/gamma'+str(t)+'value.png')
    if(cnnae):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/CNN_AE/gamma'+str(t)+'value.png')
    if(contra_ae):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/Contra_AE/gamma'+str(t)+'value.png')
    if(mlp_vae):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/MLP_VAE/gamma'+str(t)+'value.png')
    if(cnn_vae):
        plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_0_percent_noise/CNN_VAE/gamma'+str(t)+'value.png')
