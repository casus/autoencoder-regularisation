...
#lab0data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label0.pt')
#lab0data = lab0data[:Analys_size]

#lab1data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label1.pt')
#lab1data = lab1data[:Analys_size]

#lab2data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label2.pt')
#lab2data = lab2data[:Analys_size]

#lab3data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label3.pt')
#lab3data = lab3data[:Analys_size]

#lab4data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label4.pt')
#lab4data = lab4data[:Analys_size]

#lab5data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label5.pt')
#lab5data = lab5data[:Analys_size]

#lab6data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label6.pt')
#lab6data = lab6data[:Analys_size]

#lab7data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label7.pt')
#lab7data = lab7data[:Analys_size]

#lab8data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label8.pt')
#lab8data = lab8data[:Analys_size]

#lab9data = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/fashionMNISTClassifiedTestData/label9.pt')
#lab9data = lab9data[:Analys_size]

#testImages = torch.cat((lab1data, lab2data, lab3data, lab4data, lab5data, lab6data,  lab7data, lab8data, lab9data))

proz = 0.2

#testImages = torch.cat((lab1data, lab2data))


#testImages = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders-STORAGE_SPACE/FMNIST_RK_coeffs/testImages_N_20.pt',map_location=torch.device('cpu'))
...
for i in range(len(testImages)):
    #plt.imshow(testImages[i][0])
    #plt.savefig('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/first100images_/img'+str(i)+'.png')
    testImages[i] = ( testImages[i].max() - testImages[i].min() ) * torch.rand(1, 32, 32) * proz + testImages[i]
...
#all_hyb_base_models.append(model_reg)
...
rec_bAE_test = model_reg.encoder(testImages.float())#.view(all_test_coeffs[i].shape)
#rec_bAE_test = all_hyb_base_models[i](testImages.float()).view(testImages.shape)    
...
#print('edges_lat20',edges_lat20)
#print('edge_lengths_lat20', edge_lengths_lat20)
