...
with open ('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/topological_analysis_in_latent_space/geodesics_input_perturbed/geodesic_btw_Im8_Im83_at_lat_dim_4_70_percent_noise/MLP_VAE/distances.txt', 'w') as file:  
    file.write('wassDistList')
    file.write('\n')  
    file.write(str(wassDistList))
    file.write('\n')  
    file.write('\n')  
    file.write('sum(wassDistList)')  
    file.write('\n')  
    file.write(str(sum(wassDistList)))
