...
Hybrid_poly_deg = 80
latent_dim = 40
gnp = 20 # gaussian noise percentage
...
'''for k in range(len(testImages)):
    ...
    plt.axis('off')
    plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/first_100_MRI_images/MRI_image'+str(k)+'.png')'''
...
########### Other AE embeddings with normalizing ######################
...
for k in Geodesic:
    ...
    plt.axis('off')
    if(aereg):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/AE_REG/gamma'+str(t)+'value.png')
    if(Hybrid_aereg):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/Hybrid_AE_REG/gamma'+str(t)+'value.png')
    if(mlpae):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/MLP_AE/gamma'+str(t)+'value.png')
    if(cnnae):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/CNN_AE/gamma'+str(t)+'value.png')
    if(contra_ae):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/Contra_AE/gamma'+str(t)+'value.png')
    if(mlp_vae):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/MLP_VAE/gamma'+str(t)+'value.png')
    if(cnn_vae):
        plt.savefig('/home/ramana44/autoencoder-regularisation-/topological_analysis_in_latent_space/geodesics_input_perturbed_MRI/geodesic_btw_Im'+str(input_im1)+'_Im'+str(input_im2)+'_at_lat_dim_'+str(chosen_lat_dim)+'_'+str(gnp)+'_percent_noise/CNN_VAE/gamma'+str(t)+'value.png')

    plt.close()
    if(t+1 < len(Geodesic)):
        wassDistance = ot.sliced_wasserstein_distance(trainImages[Geodesic[t]][0], trainImages[Geodesic[t+1]][0], seed=0)  
