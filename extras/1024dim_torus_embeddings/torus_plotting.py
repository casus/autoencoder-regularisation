...
torch.save(model_convAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints/model_convAE.pt')
...
model_contra.load_state_dict(torch.load(path_unhyb+'model_base_contraAE_tor'+name_unhyb_contraae, map_location=torch.device(device)), strict=False)
...
torch.save(model_contra, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints/model_contra.pt')
