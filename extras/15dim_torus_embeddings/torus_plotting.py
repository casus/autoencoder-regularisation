...
model_reg.load_state_dict(torch.load(path_unhyb+'model_reg_tor'+name_unhyb, map_location=torch.device(device)))
model_base.load_state_dict(torch.load(path_unhyb+'model_base_tor'+name_unhyb, map_location=torch.device(device)))
...
fifteen_dim_sphere_train = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/torus_dataset/15_dim_test_data_torus_1000.pt')
...
torch.save(rec_rAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/1000Points/rec_rAE.pt')

torch.save(rec_bAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/1000Points/rec_bAE.pt')
...
model_convAE.load_state_dict(torch.load(path_unhyb+'model_base_cae_tor'+name_unhyb_cae, map_location=torch.device(device)), strict=False)
...
torch.save(model_convAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/1000Points/model_convAE.pt')
...
torch.save(model_contra, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/1000Points/model_contra.pt')
...
torch.save(model_mlpVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/1000Points/model_mlpVAE.pt')
...
torch.save(model_betaVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/1000Points/model_betaVAE.pt')
