...
name_unhyb = '_'+reg_nodes_sampling+'__'+str(frac)+'_'+str(alpha_rAE)+'_'+str(hidden_size)+'_'+str(deg_poly_rAE)+'_'+str(latent_dim)+'_'+str(lr)+'_'+str(no_layers)#+'_'+str(no_epochs)
...
model_reg.load_state_dict(torch.load(path_unhyb+'model_reg_tor200'+name_unhyb, map_location=torch.device(device)))
model_base.load_state_dict(torch.load(path_unhyb+'model_base_tor200'+name_unhyb, map_location=torch.device(device)))
...
A_transform5 = np.random.uniform(-1.0, 1.0, 2*15).reshape(2, 15)
...
A_transform5 = np.random.uniform(-1.2, 1.2, 3*15).reshape(3, 15)
A_trans_torus = torch.tensor(A_transform5)

#A_trans_torus = torch.rand(3, 15)
#torch.save(A_trans_torus, '/media/chethan/New Volume/Thesis/circle_torus_autoencoder_experiments/A_trans_torus.pt')
#A_trans_torus = torch.load('/media/chethan/New Volume/Thesis/circle_torus_autoencoder_experiments/A_trans_torus.pt')
...
torch.save(rec_rAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/200trainingPoints/rec_rAE.pt')

torch.save(rec_bAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/200trainingPoints/rec_bAE.pt')
...
model_convAE.load_state_dict(torch.load(path_unhyb+'model_base_cae_tor200'+name_unhyb_cae, map_location=torch.device(device)), strict=False)
...
torch.save(model_convAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/200trainingPoints/model_convAE.pt')
...
model_contra.load_state_dict(torch.load(path_unhyb+'model_base_contraAE_tor200'+name_unhyb_contraae, map_location=torch.device(device)), strict=False)
...
torch.save(model_contra, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/200trainingPoints/model_contra.pt')
...
model_mlpVAE.load_state_dict(torch.load(path_unhyb+'model_base_mlp_vae_tor200'+name_unhyb_vae, map_location=torch.device(device)), strict=False)

model_betaVAE = ConvVAE_circle(image_channels=1, h_dim=5*4, z_dim=latent_dim).to(device)
model_betaVAE.load_state_dict(torch.load(path_unhyb+'model_base_cnn_vae_tor200'+name_unhyb_vae, map_location=torch.device(device)), strict=False)
...
torch.save(model_mlpVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/200trainingPoints/model_mlpVAE.pt')
...
torch.save(model_betaVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/200trainingPoints/model_betaVAE.pt')
