...
model_reg.load_state_dict(torch.load(path_unhyb+'model_reg_tor50'+name_unhyb, map_location=torch.device(device)))
model_base.load_state_dict(torch.load(path_unhyb+'model_base_tor50'+name_unhyb, map_location=torch.device(device)))
...
torch.save(rec_rAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/50trainingPoints/rec_rAE.pt')

torch.save(rec_bAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/50trainingPoints/rec_bAE.pt')
...
model_convAE.load_state_dict(torch.load(path_unhyb+'model_base_cae_tor50'+name_unhyb_cae, map_location=torch.device(device)), strict=False)
...
torch.save(model_convAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/50trainingPoints/model_convAE.pt')
...
model_contra.load_state_dict(torch.load(path_unhyb+'model_base_contraAE_tor50'+name_unhyb_contraae, map_location=torch.device(device)), strict=False)
...
torch.save(model_contra, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/50trainingPoints/model_contra.pt')
...
model_mlpVAE.load_state_dict(torch.load(path_unhyb+'model_base_mlp_vae_tor50'+name_unhyb_vae, map_location=torch.device(device)), strict=False)

model_betaVAE = ConvVAE_circle(image_channels=1, h_dim=5*4, z_dim=latent_dim).to(device)
model_betaVAE.load_state_dict(torch.load(path_unhyb+'model_base_cnn_vae_tor50'+name_unhyb_vae, map_location=torch.device(device)), strict=False)
...
torch.save(model_mlpVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/50trainingPoints/model_mlpVAE.pt')
...
torch.save(model_betaVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/15dim_torus_embeddings/embedded_point_cloud_saved/50trainingPoints/model_betaVAE.pt')
