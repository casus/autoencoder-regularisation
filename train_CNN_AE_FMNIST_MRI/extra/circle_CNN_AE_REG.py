...
for epoch in range(num_epochs):
    ...
    for img in image_batches_trn:
        ...
        loss_C1, Jac = computeC1Loss_upd(nodes_subsample, model, device, guidanceTerm = use_guidance) # guidance term
        
        loss_reconstruction = criterion(recon, img)
...
torch.save(model.state_dict(), path+'/model_base_caereg_circ'+name)