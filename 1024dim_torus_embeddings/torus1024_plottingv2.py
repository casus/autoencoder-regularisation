...
# 3 training points
training_points = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/torus_dataset/1024_dim_torus_5000ptsv2.pt').to(device)
...
fifteen_dim_sphere_train = torch.load('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/torus_dataset/1024_dim_torus_5000ptsv2.pt')
...
torch.save(rec_rAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints5000testPointsv2/rec_rAE.pt')

torch.save(rec_bAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints5000testPointsv2/rec_bAE.pt')
...
torch.save(model_convAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints5000testPointsv2/model_convAE.pt')
...
torch.save(model_contra, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints5000testPointsv2/model_contra.pt')
...
model_mlpVAE.load_state_dict(torch.load(path_unhyb+'model_base_mlp_vae_tor'+name_unhyb_vae, map_location=torch.device(device)), strict=False)

model_betaVAE = ConvVAE_circle(image_channels=1, h_dim=5*4, z_dim=latent_dim).to(device)
model_betaVAE.load_state_dict(torch.load(path_unhyb+'model_base_cnn_vae_tor'+name_unhyb_vae, map_location=torch.device(device)), strict=False)
...
torch.save(model_mlpVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints/model_mlpVAE.pt')
...
torch.save(model_betaVAE, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders/1024dim_torus_embeddings/embedded_point_cloud_saved/24000trainingPoints/model_betaVAE.pt')
