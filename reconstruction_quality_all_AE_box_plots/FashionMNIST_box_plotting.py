...
# CHange latent dimension and get plots for different latent dimensions
latent_dim = 10
...
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/SSIM_directReconOfTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/PSNR_directReconOfTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/PSNR_ReconOf70percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/PSNR_ReconOf50percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/PSNR_ReconOf20percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/PSNR_ReconOf10percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/SSIM_ReconOf70percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/SSIM_ReconOf50percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/SSIM_ReconOf20percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
...
plt.xticks([1, 2, 3, 4, 5, 6, 7], [str(s) for s in fracs], fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('./all_results/FinalResultsPSNR_SSIM_FashionMNIST/SSIM_ReconOf10percentNoiseedTestData_LossBal'+str(alpha)+'Lat_dim'+str(latent_dim)+'TDA_'+str(frac)+'LSTSQ_deg_'+str(deg_quad)+'.png')
plt.show()
