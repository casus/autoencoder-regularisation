...
def train(train_loader, test_loader, no_epochs=60, reco_loss='mse', latent_dim=20, 
    ...
    deg_quads = [20] #, 22, 19, 23, 18, 24, 17, 25, 16]
    ...
    for deg_quad in deg_quads:
        ...
        batch_size_cfs = 200
        coeffs_saved_trn = torch.load('/home/ramana44/withR_matrix_Fmnist_RK_method/coeffs_saved/LSTSQ_traincoeffs_FMNIST_dq'+str(deg_quad)+'.pt').to(device)
        ...
        coeffs_saved_test = torch.load('/home/ramana44/withR_matrix_Fmnist_RK_method/coeffs_saved/LSTSQ_testcoeffs_FMNIST_dq'+str(deg_quad)+'.pt').to(device)
        ...
        print('coeffs_saved_trn.max()',coeffs_saved_trn.max())
        print('coeffs_saved_trn.min()',coeffs_saved_trn.min())
