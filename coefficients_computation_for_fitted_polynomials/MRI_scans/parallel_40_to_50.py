...
with concurrent.futures.ProcessPoolExecutor() as executor:
    ...
    torch.save(all_coeffs, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders-STORAGE_SPACE/savedDatasetAndCoeffs/LSTQScoeff_40_to_50.pt')
