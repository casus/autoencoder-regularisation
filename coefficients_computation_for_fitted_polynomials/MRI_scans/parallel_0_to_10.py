...
import torch
import sys
#sys.path.insert(1, '/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders-STORAGE_SPACE')
#sys.path.append('/home/ramana44/topological-analysis-of-curved-spaces-and-hybridization-of-autoencoders-STORAGE_SPACE')
...
def get_all_thetas(listedImage):
    ...
    #get = np.linalg.lstsq(np.array(X_p), Fr.reshape(96*96), rcond='warn')
