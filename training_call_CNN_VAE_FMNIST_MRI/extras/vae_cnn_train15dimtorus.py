...
image_batches_trn = torch.load('/home/ramana44/autoencoder-regularisation-/circle_dataset/15_dim_torus_2000_nonNormalized.pt').to(device)
...
image_batches_test = torch.load('/home/ramana44/autoencoder-regularisation-/circle_dataset/15_dim_torus_2000_nonNormalized.pt').to(device)
