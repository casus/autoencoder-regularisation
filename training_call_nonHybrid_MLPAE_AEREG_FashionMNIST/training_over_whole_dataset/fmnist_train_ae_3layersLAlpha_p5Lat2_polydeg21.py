...
(model, model_reg, loss_arr_reg, loss_arr_reco, loss_arr_base, loss_arr_val_reco, loss_arr_val_base) = train_ae.train(train_loader, test_loader, dx, dy, noChannels, no_epochs=100, TDA=1.0, reco_loss="mse", latent_dim=10, 
